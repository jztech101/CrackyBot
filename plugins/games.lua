...
["doll"]=	{name="doll",	cost=15000,info="A voodoo doll, do whatever you want to it.",amount=1,instock=true},
...
local itemUses = {
	...
	["junk"] = function(usr)
		...
		elseif rnd <= 60 then
			...
			return "You look at your junk and find it is actually a creepy voodoo doll (-1 junk, +1 doll)"
		elseif rnd <= 70 then
	...
	["doll"]=function(usr,args,chan)
		...
		elseif rnd <= 67 then
			return "You stick a needle in the doll. It loses all it's blood and dies (-1 doll)"
		elseif rnd <= 80 then
